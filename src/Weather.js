    ...
    fetch(
      ...
      .then(weather => {
        ...
        this.setState({
          ...
          pecipProbability: (weather.currently.precipProbability * 100).toFixed(0),
          ...
          day1Precip: (weather.daily.data[1].precipProbability * 100).toFixed(0),
          ...
          day2Precip: (weather.daily.data[2].precipProbability * 100).toFixed(0),
          ...
          day3Precip: (weather.daily.data[3].precipProbability * 100).toFixed(0),
          ...
          day4Precip: (weather.daily.data[4].precipProbability * 100).toFixed(0),
          ...
          day5Precip: (weather.daily.data[5].precipProbability * 100).toFixed(0),
          ...
          day6Precip: (weather.daily.data[6].precipProbability * 100).toFixed(0),
          ...
          hour1Precip: (weather.hourly.data[1].precipProbability * 100).toFixed(0),
          ...
          hour2Precip: (weather.hourly.data[2].precipProbability * 100).toFixed(0),
          ...
          hour3Precip: (weather.hourly.data[3].precipProbability * 100).toFixed(0),
          ...
          hour4Precip: (weather.hourly.data[4].precipProbability * 100).toFixed(0),
          ...
          hour5Precip: (weather.hourly.data[5].precipProbability * 100).toFixed(0),
          ...
          hour6Precip: (weather.hourly.data[6].precipProbability * 100).toFixed(0),
          ...
          hour7Precip: (weather.hourly.data[7].precipProbability * 100).toFixed(0),
          ...
          hour8Precip: (weather.hourly.data[8].precipProbability * 100).toFixed(0),

          hour9Time: (moment(weather.hourly.data[9].time * 1000).format(' hA')),
          hour9Temp: Math.round(weather.hourly.data[9].temperature),
          hour9Summary: weather.hourly.data[9].summary,
          hour9Precip: (weather.hourly.data[9].precipProbability * 100).toFixed(0),
          ...
          hour10Precip: (weather.hourly.data[10].precipProbability * 100).toFixed(0),
          ...
          hour11Precip: (weather.hourly.data[11].precipProbability * 100).toFixed(0),
          ...
          hour12Precip: (weather.hourly.data[12].precipProbability * 100).toFixed(0),
